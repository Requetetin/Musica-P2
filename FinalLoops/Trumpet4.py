...
trumpetLoop = Score("Trumpet4", 120)

trumpet = Part(TRUMPET, 0)
trumpetNotes =    [C4, REST, C4, REST, D4, REST, D4, REST]
trumpetDuration = [QN, DHN,  QN, DHN,  QN, DHN,  QN, DHN]
...
Write.midi(trumpetLoop, "Trumpet4.mid")
